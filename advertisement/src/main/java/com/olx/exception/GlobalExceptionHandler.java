...
@ControllerAdvice public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleInvalidAdvertisementIdError(RuntimeException exception, WebRequest request){
	...
	/*
	 * @ExceptionHandler(value = {StockName.class}) public ResponseEntity<Object>
	 * handleInvalidAdvertisementIdError(RuntimeException exception, WebRequest
	 * request){
	 * 
	 * }
	 */
